...
- **apps/nonghyup_web** — Nonghyup (농협) partner webview
- **apps/lotte_web** — Lotte Card partner webview
...
**Impact:** Proactive error detection. Each PR references specific Sentry issue IDs, showing direct response to production incidents.
...
**Key PRs:**
- `feat: migrate nonghyup-nextjs into monorepo as apps/nonghyup_web`
- `feat: add lotte_web app to monorepo`
...
- **Phase 2–7:** React best practices — eliminated SSR waterfalls, optimized useEffect dependencies, added `startTransition` for non-urgent updates ([PR #639](https://github.com/uitiorg/frontend-monorepo/pull/639))
- **Phase 5.1+6.1:** LCP image optimization and GTM consolidation ([PR #641](https://github.com/uitiorg/frontend-monorepo/pull/641))
- **Phase 8:** Performance optimizations and auth refactoring ([PR #663](https://github.com/uitiorg/frontend-monorepo/pull/663))
- **Homepage release:** Dedicated homepage performance optimization ([PR #678](https://github.com/uitiorg/frontend-monorepo/pull/678))
- **Bundle reduction:** Dynamic imports, react-spring removal ([PR #699](https://github.com/uitiorg/frontend-monorepo/pull/699))
- **Barrel import cleanup:** Storybook 10 migration, `_app` cleanup, barrel import elimination ([PR #691](https://github.com/uitiorg/frontend-monorepo/pull/691))
- **Skeleton loading:** Skeleton loading system and layout refactoring ([PR #701](https://github.com/uitiorg/frontend-monorepo/pull/701))
- **Search UX:** Show search UI immediately without waiting for map SDK ([PR #692](https://github.com/uitiorg/frontend-monorepo/pull/692))
- **State management:** Architecture cleanup with Zustand migration ([PR #718](https://github.com/uitiorg/frontend-monorepo/pull/718))
