...
export const DATA: Record<Lang, PortfolioData> = {
  en: {
    ...
    intro: '4+ years building fullstack products — from mobile apps and data pipelines to AI services. Managed a 4-person dev team, shipping 8,231 GitHub-verified commits and 1,588 PRs through AI-augmented workflows.',
    stats: [
    ...
    flagship: [
      { id: 'frontend-monorepo', name: 'Frontend Monorepo', metric: '1,130 PRs', impact: '3 repos → 1 monorepo. PageSpeed 20→80, type safety 98%+' },
  ...
  ko: {
    ...
    intro: '4년 이상의 풀스택 프로덕트 개발 — 모바일 앱, 데이터 파이프라인부터 AI 서비스까지. 4인 개발팀을 이끌며 AI 기반 워크플로우로 8,231건의 GitHub 검증 커밋과 1,588건의 PR을 달성.',
    stats: [
    ...
    flagship: [
      { id: 'frontend-monorepo', name: '프론트엔드 모노레포', metric: '1,130 PR', impact: '3개 레포 → 1개 모노레포. PageSpeed 20→80, 타입 안전성 98%+' },
